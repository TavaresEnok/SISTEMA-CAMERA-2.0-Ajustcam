    ...
    },
    {
      ...
      articles: [
        ...
        article(
          'sites-areas-mapas',
          'Sites, áreas e mapas',
          'Hierarquia física da instalação e como as câmeras aparecem na planta.',
          ['apps/api/src/sites', 'apps/api/src/areas', 'apps/api/src/site-map-layouts', 'apps/web/src/pages/MapPage.tsx'],
          [
            flow([
              ...
              'Layout do mapa preserva planta, coordenadas e apresentação',
              'Operador abre a planta e navega para live/PTZ conforme sua permissão',
            ]),
            table(
              ['Entidade', 'Função', 'Regra de integridade'],
              [
                ['Site', 'Unidade, prédio ou local monitorado.', 'Não remover silenciosamente enquanto áreas/layouts dependem dele.'],
                ['Area', 'Setor dentro do site.', 'Pertence a um site e usa IDs validados.'],
                ['SiteMapLayout', 'Estado visual da planta e posições.', 'Upsert por site, com payload limitado e autorização administrativa.'],
                ['Camera', 'Ponto de vídeo apresentado no mapa.', 'O mapa não concede acesso; só exibe o que a API autorizou.'],
              ],
            ),
            callout('warning', 'Mapa não é permissão', 'Conhecer posição ou ID de uma câmera não libera live, playback ou PTZ. Cada ação aberta pelo mapa repete a autorização do recurso.'),
          ],
          ['site', 'área', 'mapa', 'planta'],
        ),
        article(
          'layouts-grade-wall',
          ...
          [
            table(
              ...
              [
                ...
                ['/map', 'OPERATOR', 'Sites, planta e câmeras posicionadas.'],
                ...
                ['/app-builder', 'ADMIN', 'Parâmetros e artefatos mobile.'],
              ],
            ),
    ...
    },
    {
      ...
      articles: [
        ...
        article(
          ...
          ['apps/api/src/app-builder', 'apps/mobile/scripts/build-agent.mjs', 'apps/mobile/scripts/build-client.sh', 'apps/mobile/app.config.js', 'apps/central/src/server.js'],
          [
            flow([
