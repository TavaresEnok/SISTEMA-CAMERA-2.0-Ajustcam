        ...
        articles: [
          {
            ...
            body: `
              ...
              <section class="doc-section"><h2>Dimensionar corretamente</h2><p>O consumo depende de quantidade de câmeras, qualidade, quadros por segundo, complexidade da cena, horas gravadas por dia e dias de retenção.</p><div class="feature-grid"><a class="feature-card" href="/capacidade/"><h3>Dimensionar o servidor</h3><p>Calcule CPU, memória, disco e banda de rede para o porte da instalação.</p></a><a class="feature-card" href="/armazenamento/"><h3>Entender o armazenamento</h3><p>Compare qualidade, bitrate, retenção e gravação por movimento.</p></a></div></section>
